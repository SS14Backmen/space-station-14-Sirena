...
public sealed partial class ChannelFilterPopup : Popup
{
    ...
    public ChannelFilterPopup()
    {
        ...
        HighlightEdit.OnTextEntered += HighlightEditEntered;
    }
    ...
    private void HighlightEditEntered(LineEditEventArgs args)
    {
        OnNewHighlights?.Invoke(args.Text);
    }
